...
class PopularityChartsScreen extends StatefulWidget {
  const PopularityChartsScreen({super.key});

  @override
  State<PopularityChartsScreen> createState() => _PopularityChartsScreenState();
}

class _PopularityChartsScreenState extends State<PopularityChartsScreen> {

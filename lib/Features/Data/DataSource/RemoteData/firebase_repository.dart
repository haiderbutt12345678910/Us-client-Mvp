...
//MultiPurpoes Function
  //1.used to read the all the data if parameters are passed with null values(contains info about total votes daily for voting dates,contains data for specific charaters for all dates,
  //
  //
...
//Read Chracters
  ...
  Future<List<CharacterEntity>> readChracters();
}
